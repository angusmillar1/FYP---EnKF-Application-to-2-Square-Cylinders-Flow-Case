...
if mean_squared_error:
    ...
    MSE_tot = (1/(2*N)) * (np.sum(se_u) + np.sum(se_v))
    ...
    if not os.path.exists(output_file):
        ...
        with open(output_file, mode='w', newline='') as file:
            ...
            writer.writerow(["T", "MSE_u", "MSE_v", "MSE_tot"])
    ...
    with open(output_file, mode='a', newline='') as file:
        ...
        writer.writerow([timestep, MSE_u, MSE_v, MSE_tot])
        print(f"Values [T, MSE_u, MSE_v, MSE_tot] appended to error_write.csv")
