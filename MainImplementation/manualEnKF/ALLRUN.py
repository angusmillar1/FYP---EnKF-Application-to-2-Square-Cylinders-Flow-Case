...
file_write_freq = 300  # Frequency at which to write out data, assuming deltaT=0.01 (100=>T=1)
...
runtime = 15         # Set the runtime between each EnKF filtering
prog_endtime = 225   # Set the total run time of the program
